...
class UserTasksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_task" do
    assert_difference('UserTask.count') do
      post user_tasks_url, params: { user_task: { description: @user_task.description, state: @user_task.state, user_id: @user_task.user_id } }, as: :json
    end
  ...
  test "should update user_task" do
    patch user_task_url(@user_task), params: { user_task: { description: @user_task.description, state: @user_task.state, user_id: @user_task.user_id } }, as: :json
    assert_response 200
  end
